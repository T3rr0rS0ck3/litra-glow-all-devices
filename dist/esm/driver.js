...
export const findAllDevices = () => {
    ...
    const matchingDevices = devices.filter((device) => device.vendorId === DeviceConstants.VENDOR_ID &&
        device.productId === DeviceConstants.PRODUCT_ID &&
        device.usagePage === DeviceConstants.USAGE_PAGE);
    if (matchingDevices) {
        return matchingDevices.map((device) => new HID.HID(device.path));
    }
    else {
        return null;
    }
 ...
 */
export const setTemperatureInKelvin = (devices, temperatureInKelvin) => {
 ...
 */
export const setTemperaturePercentage = (devices, temperaturePercentage) => {
 ...
 */
export const setBrightnessInLumen = (devices, brightnessInLumen) => {
 ...
 */
export const setBrightnessPercentage = (devices, brightnessPercentage) => {
